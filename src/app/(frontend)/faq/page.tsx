...
const FALLBACK_FAQS: AccordionItem[] = [
  ...
  { question: 'Can you clean inside the fridge or oven?', answer: 'Yes, both are available as add-ons for $30 each. Just let Chelsea know when you book so the time is built into the appointment.' },
